...
![Time Series](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircraftinsitu.png?raw=true)
...
![Vertical profiles](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircraftinsitu_vert.png?raw=true)
