...
![Time series](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircore.png?raw=true)
...
![Vertical profiles](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircore_vert.png?raw=true)
