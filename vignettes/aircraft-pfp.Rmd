...
if(nrow(receptor_agl) > 0) {
  message(paste0(out, "_", cate, "receptor_AGL.txt"), "\n")

  fwrite(x = receptor_agl,
         file = paste0(out, "_", cate, "receptor_AGL.txt"),
         sep = " ")
}

if(nrow(receptor_asl) > 0) {
  message(paste0(out, "_", cate, "receptor_ASL.txt"), "\n")

  fwrite(x = receptor_asl,
         file = paste0(out, "_", cate, "receptor_ASL.txt"),
         sep = " ")
...
Finally, we just plot some data

```{r obs_plot, fig.width=7, fig.height=5}
