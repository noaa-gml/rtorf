...
vignette: >
  %\VignetteIndexEntry{aircraft-flask}
...
Now we read the `aircraft-flask` using the function `obs_read_nc`. To this date,
...
![Times Series](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircraftflask.png?raw=true)
...
x <- df3
x$ch4 <- x$value*1e+9
png("../man/figures/obsplot_aircraftflask_vert.png", width = 1500, height = 1000, res = 200)
obs_plot(x, 
         time = "ch4", 
         y = "altitude_final", 
...
![Vertical profiles](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircraftflask_vert.png?raw=true)
