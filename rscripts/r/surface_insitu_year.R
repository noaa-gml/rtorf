#example Rscript rscripts/surface_year.R 2020 obs/obs_surface-insitu.csv
...
out <- paste0("master/master_surface_insitu_", yy)
...
unique(df4$site_code)
df4[site_code == "ABT" & altitude_final == 33]
...
cat("Saving csvy in master/ \n")
notes <- c("sector: surface",
           ...
           "altitude: < 8000",
           "altitudes: includes column `max_altitude, the same because they are surface",
