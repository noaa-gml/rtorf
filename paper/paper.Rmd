...
Furthermore, the size of `data.table` is `r format(object.size(df), unit = "Mb")`.
...
`r format(object.size(df), unit = "Mb")`. Sometimes the data can be already
...
```{r, echo=FALSE, out.width="90%", fig.cap=" Example visualizations generated by a) Time series of CH₄ concentrations for the IAGOS site on March 2, 2020. (b) Vertical profiles of CH₄ concentrations from January (labeled '1') and March (labeled '3') 2020, illustrating the package's ability to compare different time periods.", fig.show='hold',fig.align='center'}
