...
vignette: >
  %\VignetteIndexEntry{surface-pfp}
...
png("../man/figures/obsplot_surfacepfp.png", width = 1500, height = 1000, res = 200)
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_surfacepfp.png?raw=true)
...
png("../man/figures/obsplot_surfacepfp_map.png", width = 1500, height = 1000, res = 200)
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_surfacepfp_map.png?raw=true)
