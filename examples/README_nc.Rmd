...
```{r}
df2 <- obs_addstime(df2)

```
solar time is not exact, then I need to cut every hour and aggregate observations
by hour. At the end I want one daily observation per day and site

# TODO ...
```{r}
df2 <- df2[hour_st %in% evening]
