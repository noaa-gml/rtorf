...
Now we read the `aircore` using the function `obs_read_nc`. To this date,
...
png("../man/figures/obsplot_aircore.png", width = 1500, height = 1000, res = 200)
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircore.png?raw=true)


```{r savesf, fig.width=5, fig.height=3, eval = T, echo = F}
library(sf)
x <- st_as_sf(df3, coords = c("longitude", "latitude"), crs = 4326)
png("../man/figures/obsplot_aircore_map.png", width = 1500, height = 1000, res = 200)
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircore_map.png?raw=true)


```{r vertplot, fig.width=5, fig.height=3, eval = T, echo = F, message=F, warning=F}
x <- df3
x$ch4 <- x$value*1e+9
png("../man/figures/obsplot_aircore_vert.png", width = 1500, height = 1000, res = 200)
obs_plot(x, 
         time = "ch4", 
         y = "altitude_final", 
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_aircore_vert.png?raw=true)
