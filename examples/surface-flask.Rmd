...
png("../man/figures/obsplot_surfaceflask.png", width = 1500, height = 1000, res = 200)
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_surfacetflask.png?raw=true)
...
png("../man/figures/obsplot_surfaceflask_map.png", width = 1500, height = 1000, res = 200)
...
![](https://github.com/noaa-gml/rtorf/blob/main/man/figures/obsplot_surfaceflask_map.png?raw=true)
