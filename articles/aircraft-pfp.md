...
Now we read the `aircraft-pfp` using the function `obs_read_nc`. To this
...
![Time series](../reference/figures/obsplot_aircraftpfp.png)
...
![Map](../reference/figures/obsplot_aircraftpfp_map.png)
...
![Vertical profiles](../reference/figures/obsplot_aircraftpfp_vert.png)
